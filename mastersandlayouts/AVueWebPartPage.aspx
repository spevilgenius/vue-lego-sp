...
<asp:Content ContentPlaceholderID="PlaceHolderAdditionalPageHead" runat="server">
    ...
    <SharePointWebControls:CssRegistration name="<% $SPUrl:~sitecollection/SiteAssets/html/static/css/editmode.css %>" After="<% $SPUrl:~sitecollection/Style Library/~language/Themable/Core Styles/pagelayouts15.css %>" runat="server"/>
